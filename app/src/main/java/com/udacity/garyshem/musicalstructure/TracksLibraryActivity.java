...
public class TracksLibraryActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_library);
        View current = findViewById(R.id.tracks);
    ...
    private void hookHeaders(){
        ...
        artists.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent artistIntent = new Intent(TracksLibraryActivity.this, ArtistsLibraryActivity.class);
        ...
        folders.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent foldersIntent = new Intent(TracksLibraryActivity.this, FoldersLibraryActivity.class);
        ...
        tracks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent tracksIntent = new Intent(TracksLibraryActivity.this, TracksLibraryActivity.class);
        ...
        playlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent playlistIntent = new Intent(TracksLibraryActivity.this, PlaylistActivity.class);
        ...
        albums.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent albumsIntent = new Intent(TracksLibraryActivity.this, AlbumsLibraryActivity.class);
    ...
    private void hookCurrentPlayback() {
        ...
        currentSongIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent playbackIntent = new Intent(TracksLibraryActivity.this, CurrentPlaybackActivity.class);
